...
export const BlockTypeSelector = ({ onSelect, onClose, query }: BlockTypeSelectorProps) => {
  ...
  if (filteredTypes.length === 0) {
    return (
      <div className="absolute top-full left-0 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg p-2 min-w-80 z-50">
  ...
  return (
    <div className="absolute top-full left-0 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg p-1 min-w-80 z-50">
